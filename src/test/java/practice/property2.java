...
public class property2 {
	...
	String cv = cl.getStringCellValue();
		...
		driver.findElement(By.xpath("//input[@name='accountname']")).sendKeys(cv);
		driver.findElement(By.xpath("(//input[@name='button'])[1]")).click();
		String text = driver.findElement(By.xpath("//span[.='[ ACC19 ] caring+ -  Organization Information']")).getText();
		if(text.contains(cv))
		{
